...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='cartitem',
            name='product_taille',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='store.producttaille', verbose_name='Product Size'),
        ),
        migrations.AddField(
            model_name='categorie',
            name='genre',
            field=models.CharField(blank=True, choices=[('homme', 'HOMME'), ('femme', 'FEMME'), ('vide', ' ')], default='', max_length=128, null=True),
        ),
        migrations.AddField(
            model_name='product',
            name='genre',
            field=models.CharField(choices=[('homme', 'HOMME'), ('femme', 'FEMME'), ('vide', ' ')], default='', max_length=128),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='relay_points', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'verbose_name': 'Relay Point',
                'verbose_name_plural': 'Relay Points',
            },
        ),
    ]
