...
<body class="hold-transition jazzmin-login-page bg-indigo-600">
    ...
    <div class="login-logo ">
        <h1>
            <picture>
                 ...
                 {% comment %} <img src="{% static jazzmin_settings.login_logo %}" alt="{{ jazzmin_settings.site_header }}"> {% endcomment %}
            </picture>
        </h1>
    </div>

    <div  class="w-full bg-white p-2 rounded-xl  ">
        <div class="card-body">
